...
const SEED_PRODUCTS: SeedProduct[] = [
  {
    ...
    variants: [
      { size: "50ml", sku: "RG-LEG-50", barcode: "6920100050", price: 64500, stock: 42 },
      { size: "100ml", sku: "RG-LEG-100", barcode: "6920100100", price: 92500, stock: 27 },
    ],
  },
  {
    slug: "reserve",
    ...
    variants: [
      { size: "50ml", sku: "RG-RES-50", barcode: "6920200050", price: 60000, stock: 55 },
      { size: "100ml", sku: "RG-RES-100", barcode: "6920200100", price: 87000, stock: 31 },
    ],
  },
  {
    slug: "royale",
    ...
    variants: [
      { size: "50ml", sku: "RG-ROY-50", barcode: "6920300050", price: 67000, stock: 38 },
      { size: "100ml", sku: "RG-ROY-100", barcode: "6920300100", price: 94500, stock: 19 },
    ],
  },
  {
    slug: "elite",
    ...
    variants: [
      { size: "50ml", sku: "RG-ELI-50", barcode: "6920400050", price: 58000, stock: 47 },
      { size: "100ml", sku: "RG-ELI-100", barcode: "6920400100", price: 82500, stock: 22 },
    ],
  },
  {
    slug: "noir",
    ...
    variants: [
      { size: "50ml", sku: "RG-NOI-50", barcode: "6920500050", price: 70000, stock: 21 },
      { size: "100ml", sku: "RG-NOI-100", barcode: "6920500100", price: 100500, stock: 12 },
    ],
  },
];
...
async function seedCoupons() {
  const coupons = [
    ...
    { code: "WELCOME20", type: "PERCENTAGE" as const, value: 20, description: "20% off your first order", minSubtotal: 22500, active: true, usageCount: 89, usageLimit: 500 },
    { code: "FREESHIP", type: "FREE_SHIPPING" as const, value: 0, description: "Free shipping on this order", active: true, usageCount: 211 },
    { code: "LEGACY50", type: "FIXED" as const, value: 11500, description: "₦11,500 off orders over ₦56,500", minSubtotal: 56500, active: true, usageCount: 34, usageLimit: 100 },
  ...
  const banners = [
    {
      ...
      subtitle: "On all orders over ₦45,000 — no code needed.",
      ctaLabel: "Shop Now",
      ctaHref: "/shop",
      active: true,
  ...
  if (existingRewards.length === 0) {
    await prisma.rewardTransaction.createMany({
      data: [
        ...
        { userId: user.id, type: "REDEEM", points: -200, description: "Redeemed for ₦2,500 off", createdAt: new Date("2026-07-11") },
